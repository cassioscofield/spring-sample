...
package br.com.cassioscofield.springsample;
...
/**
 * 
 * Basic integration tests for interview application.
 *
 * @author Cássio Scofield
 * 
 */
...
public class SpringSampleApplicationTests {
	...
	public void testHomeJsp() throws Exception {
		...
		assertThat(body).contains("<html>").contains("<h1>Redirecting</h1>");
	}
